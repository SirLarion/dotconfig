...
export const getDeltaLabelText = (timeframe: TAnalyticsTimeframe) => {
  ...
  return (
    <FormattedMessage
      ...
      defaultMessage="in the last {days} days"
  ...
  card: {
    ...
    onboardingRate: (
      <FormattedMessage
        ...
        description="Title for a card that displays the percentage of users that have onboarded in an organization"
      />
    ),
    successRate: (
      <FormattedMessage
        ...
        description="Title for a card that displays an organization's users' average rate of successes in Hoxhunt simulations"
      />
    ),
    reportingTime: (
      <FormattedMessage
        id="app.admin.dashboard.analytics.card.reportingTime"
        defaultMessage="Average reporting time"
        description="Title for a card that displays an organization's users' average time to report Hoxhunt simulations"
      />
    ),
    failRate: (
      <FormattedMessage
        ...
        description="Title for a card that displays an organization's users' average rate of failures in Hoxhunt simulations"
      />
    ),
    missRate: (
      <FormattedMessage
        ...
        description="Title for a card that displays an organization's users' average rate of misses in Hoxhunt simulations"
      />
    ),
  },
};
