...
export const Intl = defineMessages({
  ...
  inviteOrgToOnboard: {
    id: 'app.organizations.list.inviteOrgToOnboard',
    defaultMessage: 'Started self-service onboarding',
    description:
      'A notification shown when an organization is successfully invited to self-service onboarding',
  },
