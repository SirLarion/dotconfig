...
import { TipContent } from '../../../../components/Tip/Tip';
      ...
      {style => (
        <React.Fragment>
          {error && (
            <ModalPortal>
              {({ handleClose }) => (
                <div className={style.classes.errorPopup}>
                  <Body>{error}</Body>
                  <Button
                        ...
                        <Button
                          ...
                          onClick={() =>
                            removeDomain({
                              ...
                              if (!data.removeOrganizationDomain.data) {
                                setError(
                                  data.removeOrganizationDomain.errors?.[0]
                                    .message
                                );
                              }
                            })
