...
import { GetQuestTemplateList } from './__generated__/GetQuestTemplatesQuery.generated';

const sortRows = (
  rows: QuestTemplateListQuery['questTemplates'],
  sortType?: ISortDescriptor
) => {
  if (sortType) {
    const sortedRows: QuestTemplateListQuery['questTemplates'] = sortBy(
      rows,
      sortType.key
    );
    const sortedValues: QuestTemplateListQuery['questTemplates'] =
...
const filterActiveRows = (rows: QuestTemplateListQuery['questTemplates']) =>
...
export const SortableQuestTemplateTable: React.FC<{
  templates: QuestTemplateListQuery['questTemplates'];
  style: any;
}> = ({ templates, style }) => {
  ...
  const [sort, setSort] = useState<{
    sortType: ISortDescriptor;
    sortedValues: QuestTemplateListQuery['questTemplates'];
  }>({
    sortType: {
      key: 'createdAt',
