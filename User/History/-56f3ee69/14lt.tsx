...
import { QuizTemplateQuery } from '../../components/QuizTemplateSelector/QuizTemplateQuery';
import { GetQuizTemplatesDocument } from '../../components/QuizTemplateSelector/__generated__/GetQuizTemplates.generated';
...
export const QuizTemplateSelector = ({
  ...
  return (
    <QuizTemplateQuery
      query={GetQuizTemplatesDocument}
