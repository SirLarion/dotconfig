...
import { CustomLayer, LineSvgProps, ResponsiveLine } from '@nivo/line';
...
export const LineGraph: FC<ILineGraphProps> = ({ series, overrides = {} }) => {
  const theme = useTheme() as TTheme;

  console.log(series);

  const { styleBySerieId, overrides: seriesOverrides } =
  ...
  const DEFAULT_GRAPH_SETTINGS: Omit<LineSvgProps, 'data'> = useMemo(
    () => ({
      ...
      layers: [
        ...
        'markers',
        'areas',
        getLineStylingLayer(styleBySerieId),
        'slices',
        'axes',
        'points',
        'legends',
