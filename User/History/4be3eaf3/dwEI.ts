...
import {
  GetTimeseriesForCountryQueryResult,
  GetTimeseriesForDepartmentQueryResult,
...
type TQueryResults =
  | GetTimeseriesForDepartment
  | GetTimeseriesForCountry
  | GetTimeseriesForOrganization;

// These two cover all cases of variables
type TQueryVars =
  | GetTimeseriesForDepartmentVariables
  | GetTimeseriesForOrganizationVariables;

type TCubeEdge =
  | GetTimeseriesForDepartment_cube_edges
  | GetTimeseriesForCountry_cube_edges;
