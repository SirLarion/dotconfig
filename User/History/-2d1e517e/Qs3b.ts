...
export enum EHandlerSignature {
  ADMIN_LICENSES_GET_ORG_LICENSE_SETS = 'admin.licenses.getOrgLicenseSets',
  ADMIN_LICENSES_LIST_ALL = 'admin.licenses.listAll',
  ...
  ADMIN_ORGANIZATION_ONBOARDING_SEND_ONBOARDING_INVITATION_TO_ADMINS = 'admin.organizationOnboarding.sendOnboardingInvitationToAdmins',
  ...
  ADMIN_USER_MANAGEMENT_CREATE_USER_LIST_CSV_FILE = 'admin.userManagement.createUserListCsvFile',
  ADMIN_USER_MANAGEMENT_RUN_LARGE_USER_LIST_CSV_CREATION_FLOW = 'admin.userManagement.runLargeUserListCsvCreationFlow',
  ADMIN_USER_MANAGEMENT_SEND_USER_LIST_CSV_EMAIL = 'admin.userManagement.sendUserListCsvEmail',
  ...
  ANALYTICS_SINK_TRACK_DETACHED = 'analytics.sink.trackDetached',
  ...
  COLLECTION_HUNTING_SEARCH_JOB_RESULT_ADD_HUNTING_SEARCH_JOB_ID = 'collection.huntingSearchJobResult.addHuntingSearchJobId',
  ...
  COLLECTION_ORGANIZATION_REMOVE_DOMAIN = 'collection.organization.removeDomain',
  ...
  GAME_ENGINE_SELECT_NEXT_QUEST_TEMPLATE = 'game.engine.selectNextQuestTemplate',
  GAME_LEADERBOARD_ENRICH_USER_LEADERBOARD_ROWS = 'game.leaderboard.enrichUserLeaderboardRows',
  ...
  GAME_QUEST_TEMPLATE_COMPILE_QUEST_TEMPLATE_EDITOR_PREVIEW = 'game.questTemplate.compileQuestTemplateEditorPreview',
  ...
  GAME_USER_SCHEDULE_STAT_RECALCULATION_TASKS_FOR_ORGANIZATIONS = 'game.user.scheduleStatRecalculationTasksForOrganizations',
  ...
  INTERNAL_DIAGNOSTICS_DEBUG_QUEST_ENGINE = 'internal.diagnostics.debugQuestEngine',
  ...
  ORGANIZATION_DOMAIN_ADD = 'organization.domain.add',
  ORGANIZATION_DOMAIN_REMOVE = 'organization.domain.remove',
...
export const handlerTree: THandlerFuncTree = Object.freeze({
  admin: Object.freeze({
    licenses: {
      getOrgLicenseSets: createHandlerFunc(
        ['admin', 'licenses', 'getOrgLicenseSets'],
        adminLicensesGetOrgLicenseSets
      ),
      listAll: createHandlerFunc(
        ['admin', 'licenses', 'listAll'],
        adminLicensesListAll
      ),
    },
    organizationOnboarding: {
      ...
      sendOnboardingInvitationToAdmins: createHandlerFunc(
        ['admin', 'organizationOnboarding', 'sendOnboardingInvitationToAdmins'],
        adminOrganizationOnboardingSendOnboardingInvitationToAdmins
      ),
    ...
    userManagement: {
      createUserListCsvFile: createHandlerFunc(
        ['admin', 'userManagement', 'createUserListCsvFile'],
        adminUserManagementCreateUserListCsvFile
      ),
      runLargeUserListCsvCreationFlow: createHandlerFunc(
        ['admin', 'userManagement', 'runLargeUserListCsvCreationFlow'],
        adminUserManagementRunLargeUserListCsvCreationFlow
      ),
      sendUserListCsvEmail: createHandlerFunc(
        ['admin', 'userManagement', 'sendUserListCsvEmail'],
        adminUserManagementSendUserListCsvEmail
      ),
    },
  }),
  analytics: Object.freeze({
    ...
    sink: {
      ...
      trackDetached: createHandlerFunc(
        ['analytics', 'sink', 'trackDetached'],
        analyticsSinkTrackDetached
      ),
    },
  }),
  auth: Object.freeze({
  ...
  collection: Object.freeze({
    ...
    huntingSearchJobResult: {
      addHuntingSearchJobId: createHandlerFunc(
        ['collection', 'huntingSearchJobResult', 'addHuntingSearchJobId'],
        collectionHuntingSearchJobResultAddHuntingSearchJobId
      ),
      create: createHandlerFunc(
  ...
  game: Object.freeze({
    ...
    engine: {
      ...
      selectNextQuestTemplate: createHandlerFunc(
        ['game', 'engine', 'selectNextQuestTemplate'],
        gameEngineSelectNextQuestTemplate
      ),
    },
    leaderboard: {
      enrichUserLeaderboardRows: createHandlerFunc(
        ['game', 'leaderboard', 'enrichUserLeaderboardRows'],
        gameLeaderboardEnrichUserLeaderboardRows
      ),
    ...
    questTemplate: {
      ...
      compileQuestTemplateEditorPreview: createHandlerFunc(
        ['game', 'questTemplate', 'compileQuestTemplateEditorPreview'],
        gameQuestTemplateCompileQuestTemplateEditorPreview
      ),
    ...
    user: {
      ...
      scheduleStatRecalculationTasksForOrganizations: createHandlerFunc(
        ['game', 'user', 'scheduleStatRecalculationTasksForOrganizations'],
        gameUserScheduleStatRecalculationTasksForOrganizations
      ),
  ...
  internal: Object.freeze({
    diagnostics: {
      ...
      debugQuestEngine: createHandlerFunc(
        ['internal', 'diagnostics', 'debugQuestEngine'],
        internalDiagnosticsDebugQuestEngine
      ),
    },
    experiments: {
