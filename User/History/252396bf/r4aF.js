...
import {
  GetThreatWorkQueueCurrentUserDocument,
  GetThreatWorkQueueDocument,
} from './__generated__/WorkQueue.generated';
...
export const WorkQueueContainer = compose(
  withRouter,
  graphql(GetThreatWorkQueueCurrentUserDocument),
  graphql(GetThreatWorkQueueDocument, {
