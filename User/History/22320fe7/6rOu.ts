...
export default defineMessages({
  ...
  hiUser: {
    id: 'emailTemplates.general.hiUser',
  ...
  csvDownloadText: {
    id: 'emailTemplates.csvDownload.text',
    defaultMessage:
      'You requested to export a large CSV file from your Hoxhunt dashboard. Here is a link to download it!',
    description:
      'CSV download text informing the receiver that the email contains a link to download a CSV they requested',
  },
  csvDownloadButtonText: {
    id: 'emailTemplates.csvDownload.ctaText',
    defaultMessage: 'Download CSV',
    description:
      'A button that can be clicked to download a CSV file that the user had requested to be exported.',
  },
  csvDownloadCopyLinkText: {
    id: 'emailTemplates.csvDownload.copyLinkText',
    defaultMessage: 'Or copy this url to your browser',
    description:
      'CSV download text instructing the user that she can copy the download link and paste it to browser manually.',
  },
