...
is a major concern. Already, assuming the truthfulness of the
quadrilemma, it is evident that either trust or decentralization must
yield to the other. This is shown later in practice by the different
types of payment systems that have been built on blockchain.
