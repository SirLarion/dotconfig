...
high degree of scalability. Additionally, being public means, in terms
of blockchain, that the chain must be permissionless and thus security
is a major concern. Already, assuming the existence of the
quadrilemma, it is evident that two of the four properties are locked
in place. As such, either trust or decentralization must yield to the
other. This is shown later in practice by the different types of
payment systems that have been built on blockchain.
...
when using them for payments. A paper by Eichengreen
