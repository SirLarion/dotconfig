...
export const getQuestRereportedMessage = (
  questState: 'failed' | 'missed' | 'succeeded'
) => (
  <FormattedMessage
    id="app.admin.userDetails.activityTimeline.simulationRereported"
    defaultMessage="Reported {questState} simulation"
    description="Title for event on a timeline that shows user reported a simulation that had already been reported (succeeded, missed or failed)"
    values={{ questState }}
  />
);
