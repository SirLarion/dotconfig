...
import { TrainingManagementViewBeta } from '../../views/TrainingManagementBeta';
import { UserDetails } from '../../views/UserDetails';
import { UserManagement } from '../../views/UserManagement';
import { UserManagement as UserManagementBeta } from '../../views/UserManagementBeta';
import { UserManagement } from '../../views/UserManagementBeta';
import {
      ...
      <MainLayoutContent>
        <ScrollToTop>
          <Switch>
            ...
            />
            <Route path={'/um-beta'} component={UserManagementBeta} />
            <Route
              path={TRAINING_MANAGEMENT_PATH_BETA}
              component={TrainingManagementViewBeta}
            />
