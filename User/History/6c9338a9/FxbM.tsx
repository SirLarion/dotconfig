...
import { useQuestTemplatePreview } from '../../../../../../TrainingManagement/questTemplate/hooks/useQuestTemplatePreview';
...
export const ViewExampleButton: FC<IViewExampleButtonProps> = ({
  ...
  const { questTemplatePreview, templateLoading } =
    useQuestTemplatePreview(exampleQuestId);
