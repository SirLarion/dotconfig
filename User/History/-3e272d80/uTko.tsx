...
import { toActiveSearchFilter, toGqlFilter } from '../../recoil/filters';
...
export const TrainingManagementHeader: FC = ({ children, ...restProps }) => {
  ...
  const customSearchTabIndex = questListTabs.length - 1;
  const hideCustomSearchTab = activeTabIndex !== customSearchTabIndex;
  ...
  return (
    <TableHeaderWithTabs
      ...
      hideLastTab={hideCustomSearchTab}
      {...restProps}
    >
      {children}
    </TableHeaderWithTabs>
