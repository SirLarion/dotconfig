...
import { useToggleOrgGmailIntegrationMutation } from './graphql/__generated__/ToggleOrgGmailIntegration.generated';
...
export const GmailApiIntegrationForm: FC<IGmailApiIntegrationProps> = ({
  ...
  const [updateGmailIntegration] = useToggleOrgGmailIntegrationMutation();
