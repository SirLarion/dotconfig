...
export const removeOrganizationDomain = authenticatedResolver(root, args: { domainName: string }, ctx) => ctx.handlers.collection.organization.removeDomain(ctx, args);
