...
const Root = `
  ...
  type Mutation @external {
    ...
    addDomain(organizationId: ID!, domain: DomainInput!): DomainMutationResult!

    # Remove a domain from an organization. Successful if no users with email addresses under the domain exist.
    removeDomain(organizationId: ID!, domain: DomainInput!): DomainMutationResult!

    # Update organization's domain
    updateDomain(organizationId: ID!, domain: DomainInput!): DomainMutationResult!
