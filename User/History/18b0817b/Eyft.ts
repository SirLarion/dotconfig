...
const Root = `
  ...
  # User list CSV export result
  type GenerateUserCSVResult implements ActionResult {
    ...
    taskGroup: TaskGroup
    # NOTE: This user array is a hack to enable filtering by users, the resolver
    # never actually returns any users
    result: [User]
  }
  ...
  type Mutation @external {
    ...
    # @filterable
    generateUserCSVFile(organizationId: ID!, search: String, selectedColumns: [String!]!): GenerateUserCSVResult!
