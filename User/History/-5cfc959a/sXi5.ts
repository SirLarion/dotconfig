...
const isValidEmailLocal = (email: string) => email.split('@')[0].length > 0;
...
export const getEmailValidationRules = (domains: Array<{ name: string }>) => [
  {
    predicate: isNonEmptyString,
    message: 'Cannot be empty',
  },
  ...
  {
    predicate: isValidEmailLocal,
    message: 'Local part cannot be empty',
  },
];
