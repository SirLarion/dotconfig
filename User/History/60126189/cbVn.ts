...
import { RateThreatMutation } from '../../../../graphql/rateThreatMutation';
...
export const QuickRatingContainer = compose(
  withRouter,
  graphql(QuickRatingQuery, quickRatingQueryConf),
  graphql(RateThreatMutation, rateThreatMutationConf),
  withHandlers({
    rateThreat:
      ({ rateThreat }) =>
