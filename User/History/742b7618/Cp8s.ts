...
export type THandlerStubTree = Readonly<{
  admin: Readonly<{
    licenses: Readonly<{
      getOrgLicenseSets: sinon.SinonStub;
    ...
    organizationOnboarding: Readonly<{
      ...
      sendOnboardingInvitationToAdmins: sinon.SinonStub;
    ...
    userManagement: Readonly<{
      createUserListCsvFile: sinon.SinonStub;
      runLargeUserListCsvCreationFlow: sinon.SinonStub;
      sendUserListCsvEmail: sinon.SinonStub;
    }>;
  }>;
  analytics: Readonly<{
    cubes: Readonly<{
  ...
  collection: Readonly<{
    ...
    huntingSearchJobResult: Readonly<{
      addHuntingSearchJobId: sinon.SinonStub;
      create: sinon.SinonStub;
      createMany: sinon.SinonStub;
      find: sinon.SinonStub;
      get: sinon.SinonStub;
  ...
  game: Readonly<{
    ...
    engine: Readonly<{
      ...
      selectNextQuestTemplate: sinon.SinonStub;
    }>;
    leaderboard: Readonly<{
      enrichUserLeaderboardRows: sinon.SinonStub;
    ...
    questTemplate: Readonly<{
      ...
      compileQuestTemplateEditorPreview: sinon.SinonStub;
    ...
    user: Readonly<{
      ...
      scheduleStatRecalculationTasksForOrganizations: sinon.SinonStub;
  ...
  internal: Readonly<{
    diagnostics: Readonly<{
      ...
      debugQuestEngine: sinon.SinonStub;
    }>;
...
export const handlerMockTree: THandlerStubTree = Object.freeze({
  admin: Object.freeze({
    licenses: Object.freeze({
      getOrgLicenseSets: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "admin.licenses.getOrgLicenseSets"'
          )
        ),
      listAll: sinon
        .stub()
        .rejects(
          new Error('unexpected handler call: "admin.licenses.listAll"')
        ),
    }),
    organizationOnboarding: Object.freeze({
      ...
      sendOnboardingInvitationToAdmins: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "admin.organizationOnboarding.sendOnboardingInvitationToAdmins"'
          )
        ),
      start: sinon
        .stub()
    ...
    userManagement: Object.freeze({
      createUserListCsvFile: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "admin.userManagement.createUserListCsvFile"'
          )
        ),
      runLargeUserListCsvCreationFlow: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "admin.userManagement.runLargeUserListCsvCreationFlow"'
          )
        ),
      sendUserListCsvEmail: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "admin.userManagement.sendUserListCsvEmail"'
          )
        ),
    }),
  }),
  analytics: Object.freeze({
    ...
    sink: Object.freeze({
      ...
      trackDetached: sinon
        .stub()
        .rejects(
          new Error('unexpected handler call: "analytics.sink.trackDetached"')
        ),
    }),
  }),
  auth: Object.freeze({
  ...
  collection: Object.freeze({
    ...
    huntingSearchJobResult: Object.freeze({
      addHuntingSearchJobId: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "collection.huntingSearchJobResult.addHuntingSearchJobId"'
          )
        ),
      create: sinon
        .stub()
  ...
  game: Object.freeze({
    ...
    engine: Object.freeze({
      ...
      selectNextQuestTemplate: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "game.engine.selectNextQuestTemplate"'
          )
        ),
    }),
    leaderboard: Object.freeze({
      enrichUserLeaderboardRows: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "game.leaderboard.enrichUserLeaderboardRows"'
          )
        ),
    ...
    questTemplate: Object.freeze({
      ...
      compileQuestTemplateEditorPreview: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "game.questTemplate.compileQuestTemplateEditorPreview"'
          )
        ),
    ...
    user: Object.freeze({
      ...
      scheduleStatRecalculationTasksForOrganizations: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "game.user.scheduleStatRecalculationTasksForOrganizations"'
          )
        ),
      selfOnboard: sinon
        .stub()
  ...
  internal: Object.freeze({
    diagnostics: Object.freeze({
      ...
      debugQuestEngine: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "internal.diagnostics.debugQuestEngine"'
          )
        ),
    }),
  ...
  organization: Object.freeze({
    domain: Object.freeze({
      add: sinon
        .stub()
        .rejects(
          new Error('unexpected handler call: "organization.domain.add"')
        ),
      remove: sinon
        .stub()
        .rejects(
          new Error('unexpected handler call: "organization.domain.remove"')
        ),
      update: sinon
        .stub()
        .rejects(
