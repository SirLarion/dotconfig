...
export interface IAdminOrganizationIndustryUpdatedSchema {
  product: 'admin';
...
export type TAnalyticsEventSchema =
  ...
  | IAdminOrganizationIndustryUpdatedSchema
...
export interface IAdminOrganizationIndustryUpdated {
  product: 'admin';
  action: 'organization_industry_updated';
  industryId?: string;
  organizationId: string;
...
export type TAnalyticsEvent =
  ...
  | IAdminOrganizationIndustryUpdated
