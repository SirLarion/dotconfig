...
import { GetQuestTemplateAttachmentEditorPreviewDocument } from './__generated__/GetQuestTemplateAttachmentEditorPreview.generated';
...
const mapStateToProps = (state, { client, updateUI, fieldName }) => {
  ...
  return {
    onPreview: () =>
      client
        .query({
          query: GetQuestTemplateAttachmentEditorPreviewDocument,
