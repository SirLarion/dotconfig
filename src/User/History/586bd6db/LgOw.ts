...
// Do this before any env vars are read
...
const schedules = {
  ...
  generateTemplatePreviews:
    process.env.TASK_SCHEDULE_GENERATE_TEMPLATE_PREVIEWS,
...
const gmailApiDelivery = {
  ...
  requiredScopes: 'https://www.googleapis.com/auth/poopie',
...
const auth = {
  enableSuperAdminAccess: parseBoolean(process.env.ENABLE_SUPER_ADMIN_ACCESS),
...
export const appConfig = {
  ...
  gcs,
  questTemplateImagesStorageBucket:
    process.env.QUEST_TEMPLATE_IMAGES_STORAGE_BUCKET,
