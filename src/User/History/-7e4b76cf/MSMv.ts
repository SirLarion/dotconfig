...
import { withAdminRole, withUserRole } from '@server/domains/lib/contextWith';
...
describe('collection.user.patch', () => {
  ...
  it(`should allow admins to patch users' email addresses`, async () => {
    stubPatch.restore();
    ...
    const ctx = await R.pipe(withAdminRole, createIntegrationCtx)(null);
