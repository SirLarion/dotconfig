  ...
  exportCsv: {
    ...
    title: (userCount: number) => (
      <FormattedMessage
        ...
        defaultMessage="Export {userCount, plural, =1{1 user} other{# users}} as CSV"
    ...
    mailSend: (
      <FormattedMessage
        id="app.admin.userAction.progress.exportCsv"
        defaultMessage="User export in progress. We will send you an email with a link to download the CSV file."
        description="Message informing the user that the user export action is in progress and that they will recieve a link to download the resulting CSV file."
      />
    ),
