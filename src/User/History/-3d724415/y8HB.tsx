...
import { CloseButton, Modal } from '@hox/ui/Modal/v2';
...
import { AVAILABLE_COLUMNS, MAX_COLUMN_COUNT } from './constants/columns';
...
export const ColumnCustomizationOverlay: FC<{
  ...
  return (
    <Modal.Custom open={open} onDismiss={() => setOpen(false)}>
