...
export default defineMessages({
  ...
  csvDownloadButtonText: {
    id: 'emailTemplates.userCsvDownload.ctaText',
  ...
  csvDownloadCopyLinkText: {
    id: 'emailTemplates.userCsvDownload.copyLinkText',
    defaultMessage: 'Or copy this url to your browser',
    description:
      'User CSV download text instructing the user that she can copy the download link and paste it to browser manually.',
  },
