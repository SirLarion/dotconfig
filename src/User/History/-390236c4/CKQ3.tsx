...
export const USER_ACTIVITY_TIMELINE_EVENT_MESSAGES = {
  ...
  engine_quest_rereported: (
    <FormattedMessage
      id="app.admin.userDetails.activityTimeline.missedSimulationReported"
      defaultMessage="Reported expired simulation"
      description="Title for event on a timeline that shows user reported a simulation that had expired"
    />
  ),
