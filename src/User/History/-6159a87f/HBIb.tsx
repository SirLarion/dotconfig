...
import { CurrentUserAnonimityDocument } from './__generated__/CurrentUserAnonimity.generated';
import { UpdateUserAnonimityDocument } from './__generated__/UpdateUserAnonimity.generated';
...
const mutateUserProfile = (
  ...
  compose(
    callMutate(mutate, { query: CurrentUserAnonimityDocument }),
...
export const AnonymousModeSetter = compose(
  graphql(CurrentUserAnonimityDocument, currentUserQueryConf),
  graphql(UpdateUserAnonimityDocument, updateUserMutationConf),
