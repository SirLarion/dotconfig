...
import { CurrentUserAnonymityDocument } from './__generated__/CurrentUserAnonymity.generated';
import { UpdateUserAnonymityDocument } from './__generated__/UpdateUserAnonymity.generated';
...
const mutateUserProfile = (
  ...
  compose(
    callMutate(mutate, { query: CurrentUserAnonymityDocument }),
...
export const AnonymousModeSetter = compose(
  graphql(CurrentUserAnonymityDocument, currentUserQueryConf),
  graphql(UpdateUserAnonymityDocument, updateUserMutationConf),
