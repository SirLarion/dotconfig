...
export enum EServerEvent {
  ...
  ORGANIZATION_INDUSTRY_UPDATED = 'organization_industry_updated',
  ...
  RESPONSE_INCIDENT_CLASSIFIED_BY_SOC = 'response_incident_classified_by_soc',
...
export const requireOrganizationIdAnalyticsServerEvents: EServerEvent[] = [
  ...
  EServerEvent.ORGANIZATION_INDUSTRY_UPDATED,
  EServerEvent.RESPONSE_INCIDENT_CLASSIFICATION_CHANGED,
  EServerEvent.RESPONSE_INCIDENT_CLASSIFIED_BY_SOC,
];
...
export const eventDescriptions: { [key in EEvent]: string } = {
  ...
  [EServerEvent.ORGANIZATION_INDUSTRY_UPDATED]:
    "Organization's industry was updated",
  ...
  [EServerEvent.RESPONSE_INCIDENT_CLASSIFIED_BY_SOC]:
    'Incident was classified by a SOC operator',
  [EServerEvent.RESPONSE_INCIDENT_CLASSIFICATION_CHANGED]:
