...
const MOCK_DOMAIN = { name: 'moc.com', defaultUiLanguage: 'en' };
const EXISTING_DOMAIN = { name: 'if.fi', defaultUiLanguage: 'en' };
...
describe('organization.domain.add', () => {
  ...
  it('should add a domain correctly', async () => {
    ...
    expect(organization.domains).eql([MOCK_DOMAIN, EXISTING_DOMAIN]);
  });
