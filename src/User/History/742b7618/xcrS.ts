...
export type THandlerStubTree = Readonly<{
  ...
  game: Readonly<{
    ...
    questTemplate: Readonly<{
      ...
      takeAndPersistPreviewImages: sinon.SinonStub;
...
export const handlerMockTree: THandlerStubTree = Object.freeze({
  ...
  game: Object.freeze({
    ...
    questTemplate: Object.freeze({
      ...
      generateTemplatePreviews: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "game.questTemplate.generateTemplatePreviews"'
          )
        ),
      ...
      takeAndPersistPreviewImages: sinon
        .stub()
        .rejects(
          new Error(
            'unexpected handler call: "game.questTemplate.takeAndPersistPreviewImages"'
          )
        ),
