...
import { GetOrgIncidentSettingsDocument } from './graphql/__generated__/GetOrgIncidentSettings.generated';
import { SaveOrgIncidentSettingsDocument } from './graphql/__generated__/SaveOrgIncidentSettings.generated';
import { SaveOrgIncidentPolicySettingsDocument } from './graphql/__generated__/SaveOrgIncidentPolicySettings.generated';
...
export const IncidentSettings: React.SFC<IIncidentSettingFormProps> = ({
  ...
  <OrgIncidentSettingsQuery
    query={GetOrgIncidentSettingsDocument}
    variables={{ organizationId }}
  >
    {({ data: { organizations } }) => (
      <>
        <OrgIncidentSettingsMutation
          mutation={SaveOrgIncidentSettingsDocument}
          ignoreResults
        >
          {mutate => (
        ...
        <OrgIncidentPolicySettingsMutation
          mutation={SaveOrgIncidentPolicySettingsDocument}
          ignoreResults
        >
          {mutate => (
