  ...
  const dropDownItems = useMemo(
    () =>
      R.pipe(
        ...
        R.map((item: GetActiveQuizTemplatesQuery['quizTemplates'][number]) => ({
          value: item.tag,
          _id: item.tag,
        })),
      ...
      {({ handleClose }) => (
        ...
        >
          <Content>
            ...
            />
            <ToggleRow>
              {SECONDARY_OBJECTIVES.map((objective, i) => (
                <Toggle
                  key={i}
