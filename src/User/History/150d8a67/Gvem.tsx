...
import { QuestSecondaryObjective } from '../../graphql/__generated__/globalTypes';
...
import {
  GetActiveQuizTemplates,
  GetActiveQuizTemplates_quizTemplates,
} from './__generated__/GetActiveQuizTemplates';
...
export const QuestSendingModal: FC<IQuestSendingModalProps> = ({
  ...
  const [sendQuestToCurrentUser, { loading }] = useMutation(
    SEND_QUEST_TO_CURRENT_USER
  );
  ...
  const { data, loading: loadingTemplateIds } =
    useQuery<GetActiveQuizTemplates>(GET_ACTIVE_QUIZ_TEMPLATES);
