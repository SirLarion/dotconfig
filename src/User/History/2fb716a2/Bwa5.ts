...
/*
 * Creates Industry objects corresponding to current customer industries. Adds
...
export default createMigration({
  ...
  up: async (_, ctx) => {
    ...
    logger.info(
      ctx,
      `
      3. All done! All existing organizations should now have an industryId for their respective industry.
    `
    );
  },
});
