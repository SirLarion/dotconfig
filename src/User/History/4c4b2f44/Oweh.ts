...
const MOCK_EXISTING_INDUSTRY_NAME = 'Lego building';
const MOCK_NEW_INDUSTRY_NAME = 'Lego structure modifying';
...
describe('collection.industry.patch', async () => {
  ...
  it('should not allow setting an empty name for an industry', async () => {
    ...
    ).rejectedWith('Name is required in Industries update');
  });
