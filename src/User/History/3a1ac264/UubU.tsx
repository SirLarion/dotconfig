...
import { GetQuestTemplateTagsDocument } from '../../components/QuestTemplateSelector/__generated__/GetQuestTemplateTags.generated';
...
export const QuestTemplateSelector = ({
  ...
  return (
    <QuestTemplateQuery query={GetQuestTemplateTagsDocument}>
      {({ loading, error, data }) => {
        return (
          <Select
            style={{
