...
export const CUSTOM_COLUMN_INTL: Record<string, ReactNode> & {
  ...
  columnName: {
    ...
    email: (
      <FormattedMessage
        id="app.admin.userList.columName.email"
    ...
    isAnonymous: (
      <FormattedMessage
        id="app.admin.userList.columnName.isAnonymous"
    ...
    questLanguages: (
      <FormattedMessage
        id="app.admin.userList.columnName.questLanguages"
    ...
    language: (
      <FormattedMessage
        id="app.admin.userList.columnName.language"
