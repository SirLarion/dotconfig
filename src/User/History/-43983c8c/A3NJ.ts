...
import { OrganizationUsersFragment } from './hooks/graphql/__generated__/GetOrganizationUsers.generated';

export type TQueryUser = OrganizationUsersFragment['nodes'][number];
