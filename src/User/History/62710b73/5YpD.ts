...
const createTaskDefs = (
  ...
  t({
    id: EScheduledTaskId.GAME_QUEST_TEMPLATES_GENERATE_TEMPLATE_PREVIEWS,
    cron: schedules.generateTemplatePreviews,
    serviceFn: handlerTree.game.questTemplate.generateTemplatePreviews,
    signature: 'game.questTemplate.generateTemplatePreviews',
  }),
  t({
