...
import { palette, theme, TTheme } from '../styles/theme';
...
type TCustomLayer = (
  props: Omit<CustomLayerProps, 'xScale' | 'yScale' | 'lineGenerator'> & {
    xScale: TScaleFunction;
    yScale: TScaleFunction;
    lineGenerator: Line<ComputedDatum['position']>;
  }
) => React.ReactNode;
