...
type TCustomLayer = (props: Omit<CustomLayerProps, 'xScale' | 'yScale'> & { xScale: LineProps['xScale'], yScale: LineProps['yScale']})
...
export const getAreaStylingLayer =
  ...
  ({ series, xScale, yScale, innerHeight }: CustomLayerProps) => {
