...
export enum EHandlerSignature {
  ...
  GAME_QUEST_TEMPLATE_TAKE_AND_PERSIST_PREVIEW_IMAGES = 'game.questTemplate.takeAndPersistPreviewImages',
...
export const handlerTree: THandlerFuncTree = Object.freeze({
  ...
  game: Object.freeze({
    ...
    questTemplate: {
      ...
      takeAndPersistPreviewImages: createHandlerFunc(
        ['game', 'questTemplate', 'takeAndPersistPreviewImages'],
        gameQuestTemplateTakeAndPersistPreviewImages
      ),
