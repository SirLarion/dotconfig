...
import collectionOrganizationRemoveDomain from '@server/domains/collection/organization/removeDomain';
...
export enum EHandlerSignature {
  ...
  GAME_LEADERBOARD_ENRICH_USER_ROWS = 'game.leaderboard.enrichUserLeaderboardRows',
...
export const handlerTree: THandlerFuncTree = Object.freeze({
  ...
  collection: Object.freeze({
    ...
    organization: {
      ...
      removeDomain: createHandlerFunc(
        ['collection', 'organization', 'removeDomain'],
        collectionOrganizationRemoveDomain
      ),
