...
import { SaveOrgThresholdIncidentPolicySettingsDocument } from './graphql/__generated__/SaveOrgThresholdIncidentPolicySettings.generated';
...
> = props => (
  <OrgThresholdPolicySettingsMutation
    mutation={SaveOrgThresholdIncidentPolicySettingsDocument}
  >
    {mutate => (
      <IncidentPolicySettingsForm
        {...props}
