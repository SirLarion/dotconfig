...
const resetUsersRoles = gql`
  mutation UserListDemoteUserToNormalUser(
    $organizationId: ID!
    $selectedUserIds: [ID!]!
  ) {
    resetUsersRoles(
...
export const commands = [
  {
    ...
    superAdminOnly: true,
    mutation: gql`
      mutation UserListToggleActiveCommand(
        $organizationId: ID!
        $selectedUserIds: [ID!]!
      ) {
        toggleActive(
  ...
  },
  {
    ...
    isDangerous: true,
    mutation: gql`
      mutation UserListToggleGameModeCommand(
        $organizationId: ID!
        $selectedUserIds: [ID!]
      ) {
        toggleGameMode(
