...
import {
  UserListAddAdminRoleDocument,
  UserListAddSOCRoleDocument,
  UserListAddSuperAdminRoleDocument,
  UserListAutomaticStartDocument,
  UserListDeleteUsersDocument,
  UserListInviteUserDocument,
  UserListResetUserRolesDocument,
  UserListToggleActiveDocument,
  UserListToggleGameModeDocument,
} from './__generated__/commands.generated';
...
export const commands = [
  ...
  },
  {
    ...
    mutation: UserListInviteUserDocument,
    isDangerous: true,
  ...
  },
  {
    ...
    isDangerous: true,
    superAdminOnly: true,
    mutation: UserListAutomaticStartDocument,
    message: (
      <FormattedMessage
  ...
  {
    id: 'user.delete',
    mutation: UserListDeleteUsersDocument,
    afterMutationUpdate:
      queryVariables =>
