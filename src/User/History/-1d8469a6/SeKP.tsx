...
import { CurrentUserOrganizationDefaultSettingsQuery } from './components/UserImportTable/graphql/__generated__/CurrentUserOrganizationDefaultSettings.generated';
...
export const UserImportEmailAdditionView: FC = () => {
  const { data } = useQuery<CurrentUserOrganizationDefaultSettingsQuery>(
    GET_CURRENT_ORGANIZATION_DEFAULT_SETTINGS_QUERY
  );
