...
Sanka and Cheung \cite{sankaScalability} discuss the problem of blockchain
scalability extensively. They introduce the so called "\textit{Blockchain
Scalability Quadrilemma}" that defines the scalability of a blockchain
as a 4-way tradeoff between scalability, trust, security and decentralization.
