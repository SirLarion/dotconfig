...
import { GetQuizTemplateIdsDocument } from '../../components/QuizTemplateSelector/__generated__/GetQuizTemplates.generated';
...
export const QuizModuleSelector = ({
  ...
  return (
    <QuizModuleQuery query={GetQuizTemplateIdsDocument}>
      {({ loading, error, data }) => {
        return (
          <>
            <SelectStyled
