...
export const expectedTestQuestStateMap: Record<string, TTestStatus> = {
  ['hox.quest.bootcamp.0']: { quest: QuestState.QUEST_STATE_SUCCESS },
  ['hox.quest.bootcamp.4']: { quest: QuestState.QUEST_STATE_SUCCESS },
  ['hox.quest.bootcamp.2.en']: {
    quest: QuestState.QUEST_STATE_FAILED,
    training: true,
  },
...
export const getMicrotrainingStatus = (testCase: TestQuestFieldsFragment) => {
  ...
  return secondary.length > 0 && all(o => !!o.completedAt, secondary);
};
