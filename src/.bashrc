...
alias fetchbrc='sudo cp /home/sirlarion/Dropbox/__self__/dotconfig/.bashrc ~/.'
alias zulip='bash ~/Documents/Zulip-5.4.0-x86_64.AppImage'
...
__conda_setup="$('/home/sirlarion/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/sirlarion/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/sirlarion/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/sirlarion/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
